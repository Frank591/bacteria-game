    ...
    public class GridFileSaver : IGridHandler
    {
        ...
        public GridFileSaver(string folderPath)
        {
            ...
            if (!Directory.Exists(_folderPath))
                throw new DirectoryNotFoundException(" не найдена диретория "+_folderPath);
            string calculateResultsFolderName = "FileGridSaver_Рассчет от " + DateTime.Now.ToString("yyyyMMdd hh_mm");
