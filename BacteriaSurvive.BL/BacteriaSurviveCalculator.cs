...
namespace BacteriaSurvive.BL
{
    public class BacteriaSurviveCalculator
    {
        ...
        public BacteriaSurviveCalculator(uint stepCount, IGridHandler gridHadler, IGameAreaFactory<Bacteria> bacteriaAreaFactory, IGameAreaFactory<GameCenter> gameCenterAreaFactory)
        {
